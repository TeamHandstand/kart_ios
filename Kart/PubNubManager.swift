...
//  
//  fileprivate (set) var kartClient: PubNub?
//  
...
//  }
//  
//  func publishMessage(_ message: AnyObject, onChannel channel: String, withCompletion completion: PNPublishCompletionBlock?) {
...
//      
//      NotificationCenter.defaultCenter().postNotificationName(KartNotificationNewUserLocationReceived, object: message.data.message)
//    }
//  }
//  
